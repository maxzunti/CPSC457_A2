...
extern "C" int sched_getaffinity(pid_t pid, size_t cpusetsize, cpu_set_t *mask); // Added by Branko

extern "C" int sched_setaffinity(pid_t pid, size_t cpusetsize, cpu_set_t *mask); // Added by Branko
...
enum : mword {
  ...
  _init_sig_handler,
  max,
  sched_getaffinity, // Added by Branko
  sched_setaffinity // Added by Branko
};
